package com.example.nilopartneron.promo
...
import com.example.nilopartneron.databinding.FragmentPromoBinding
        ...
        photoSelectedUri?.let { uri ->
            binding?.let { binding ->
                getBitmapFromUri(uri)?.let { bitmap ->
                    ...
                    val  promoRef =
                        FirebaseStorage.getInstance().reference.child("promos")
                        ...
                        .addOnSuccessListener {
                            it.storage.downloadUrl.addOnSuccessListener { downloadUrl ->
                                ...
                                notificationRS.sendNotificationByTopic(
                                   ...
                                   if (it){
                                       Toast.makeText(activity, "Promocion Enviada", Toast.LENGTH_SHORT).show()
                                       dismiss()
                                   } else{
                                       Toast.makeText(activity, "Error, intente mas tarde", Toast.LENGTH_SHORT)
                                           .show()
                                   }
                                    enableUI(true)
                                }
